...
CARDS = [
 ...
 ("Votre niveau",
  ...
  ' eux-mêmes bien classés. Vos coéquipiers comptent aussi : votre variation mélange votre score et la moyenne de votre équipe &mdash; porter des alliés faibles vers la victoire rapporte plus que la même victoire dans une équipe surpuissante, et perdre avec des alliés faibles coûte moins. Une équipe en sous-effectif compte aussi comme plus faible qu&#39;une équipe complète.</p>'),
